        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="ltn__contact-address-item ltn__contact-address-item-4 box-shadow">
                    ...
                    <h3>Store Address</h3>
                    <p>Unit 5, Bloom Building, Legazpi Village, Makati City<br>
                        Metro Manila 1229, Philippines</p>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="ltn__contact-address-item ltn__contact-address-item-4 box-shadow">
                    ...
                    <h3>Phone Number</h3>
                    <p><a href="tel:+639171234567">+63 917 123 4567</a><br>
                        <a href="tel:+63288501234">(02) 8850 1234</a></p>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="ltn__contact-address-item ltn__contact-address-item-4 box-shadow">
                    ...
                    <h3>Email & Web</h3>
                    <p><a href="mailto:hello@theflowerbucket.ph">hello@theflowerbucket.ph</a><br>
                        <a href="mailto:support@theflowerbucket.ph">support@theflowerbucket.ph</a></p>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="ltn__contact-address-item ltn__contact-address-item-4 box-shadow">
                    ...
                    <h3>Opening Hours</h3>
                    <p>Mon to Sat: 9:00 AM to 7:00 PM<br>
